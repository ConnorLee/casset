  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[2px] md:top-[4px] right-1 md:right-2 flex items-center z-40">
        <Image
          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/casset-uWqAjD7R0Is7KlHmjYTwLaJ629Iq7M.png"
          alt="Casset Logo"
          width={48}
          height={16}
      ...
      {showInfo && (
        <div className="absolute inset-0 bg-white bg-opacity-90 z-50 flex flex-col items-center justify-start p-4">
          ...
          {isSideA ? (
            <>
              <Image
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/casset%20copy%203-X8fSmUFGMonh4by6KqrxtWHc0U0U0o.png"
                alt="Connor James"
                width={240}
                height={34}
      ...
      <div className="absolute bottom-4 md:bottom-6 left-0 right-0 flex flex-col gap-1 md:gap-2 z-40">
        ...
        <div className="text-center mb-1">
          <span
            className="text-lg md:text-2xl font-bold text-gray-800 font-square-peg"
